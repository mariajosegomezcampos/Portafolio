      ...
      <div className="mx-auto max-w-7xl px-6 py-8 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="flex justify-center space-x-6 md:order-2">
          ...
          <a 
            ...
            className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 hover:text-amber-500 dark:hover:text-amber-400 transition-colors relative group py-1"
            aria-label="LinkedIn"
          >
            <svg className="h-4 w-4 fill-current transition-transform group-hover:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="mt-6 md:order-1 md:mt-0 text-center md:text-left">
          ...
          <p className="text-[10px] font-mono text-slate-400 dark:text-slate-500 mt-1 uppercase tracking-widest">
