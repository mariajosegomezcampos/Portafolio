...
import { useTheme } from '../context/ThemeContext' // 1. Importa el hook
...
export default function Navbar(): React.JSX.Element {
  ...
  // 2. Usamos el contexto global en lugar del estado local
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 justify-between items-center">
          ...
          <div className="hidden sm:flex items-center gap-3">
             <button onClick={toggleTheme} className="p-2 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-yellow-400 transition-colors">
               {isDark ? '☀️' : '🌙'}
             </button>
